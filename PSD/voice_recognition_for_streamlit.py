...
def load_model():
    ...
    try:
        ...
        model_path = os.path.join(current_dir, 'optimized_model.pkl')
        scaler_path = os.path.join(current_dir, 'optimized_scaler.pkl')
        le_path = os.path.join(current_dir, 'optimized_le.pkl')
